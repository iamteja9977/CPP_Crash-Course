// This code is a copy constructor for a class called Array. The purpose of a copy constructor is
...
{
    //  this copy constructor creates a deep copy of the rhsObj object,
    // copying its array a (if it's not empty) element by element into the current object's array a
    if (size > 0)
    {
        a = new int[size];
